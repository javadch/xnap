...
import { shareViaTelegram, shareViaOS, initShareDropdowns } from './share.js';
...
export function renderGrid(items) {
    ...
    items.forEach(item => {
            ...
            <div class="card-body">
                ...
                <div class="card-actions">
                    ...
                    <div class="share-dropdown">
                        <button class="card-btn share-btn share-dropdown-toggle" title="Share">
        ...
        shareDropdown.querySelector('.share-dropdown-toggle').addEventListener('click', (e) => {
            e.stopPropagation();
        ...
        shareDropdown.querySelector('.share-telegram-opt').addEventListener('click', (e) => {
            e.stopPropagation();
            shareDropdown.classList.remove('open');
            shareViaTelegram(item);
        });
        shareDropdown.querySelector('.share-os-opt').addEventListener('click', (e) => {
            e.stopPropagation();
            shareDropdown.classList.remove('open');
            shareViaOS(item);
        });
